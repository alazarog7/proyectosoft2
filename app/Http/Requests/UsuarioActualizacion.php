...
use App\Rules\Administrador;
use Illuminate\Foundation\Http\FormRequest;

class UsuarioActualizacion extends FormRequest
{
    /**
    ...
    {
        return [
                'ROL'=>['required', new Administrador]
               ];
        /*return [
            'ROL'=>['required', new Administrador],
    ...
    {
        return ['ROL'=>'Error al actualizar el ROL'];
        /*return [
            ...
            'ROL.admin'=>'Solo hay un administrador'
        ];*/
    }
}
